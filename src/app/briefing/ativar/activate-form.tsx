...
import { PasswordInput } from "../entrar/password-input";
import { primaryButtonClass } from "../entrar/styles";
  ...
  return (
    <form action={action} className="grid gap-4">
      ...
      <label className="grid gap-1.5 text-sm font-medium text-[#54382c]">Nova senha
        <PasswordInput name="password" autoComplete="new-password" placeholder="mínimo 8 caracteres" />
      </label>
