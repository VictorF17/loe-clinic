    ...
    <main className="min-h-screen overflow-hidden bg-[#f7f3ee] text-[#54382c]">
      <section className="relative isolate min-h-[760px] overflow-hidden px-5 pb-14 pt-5 sm:px-10 lg:min-h-[800px] lg:px-16">
        ...
        <header className="mx-auto flex max-w-7xl items-center justify-between border-b border-[#7b5542]/15 pb-4">
          ...
          <nav className="hidden items-center gap-8 text-sm text-[#6d4c3d] md:flex"><a className="transition-colors hover:text-[#a26b50]" href="#essencia">A essência</a><a className="transition-colors hover:text-[#a26b50]" href="#experiencia">A experiência</a><a className="transition-colors hover:text-[#a26b50]" href="/briefing">Briefing</a></nav>
